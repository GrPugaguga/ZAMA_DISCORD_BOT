...
from app.vt_proccessor.utils import vector_search
from app.vt_proccessor.prompt import MAIN_PROMPT,UPDATE_PROMPT
import logging

logger = logging.getLogger(__name__)


class QueryProcessor_vt:
    ...
    async def process_query(self, question: str) -> str:
        ...
        try:
            ...
            logger.info(f"Finded context: {context}")
    ...
    async def _generate_answer(self, question: str, context: str) -> str:
        ...
        try:
            ...
            return f"""ANSWER from vector title\n {response}"""
